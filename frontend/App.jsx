  ...
  return (
    <div style={{ fontFamily:"'JetBrains Mono','Courier New',monospace", background:C.bg, minHeight:"100vh", display:"flex", flexDirection:"column", color:C.text, padding:14, boxSizing:"border-box" }}>
      ...
      <div style={{ flex:1, minHeight:0, display:"flex", gap:0, justifyContent:"center", alignItems:"stretch", minWidth:"min-content" }}>
        ...
        <div style={{ display:"flex", flexDirection:"column", gap:8, width:350, minWidth:200, flexShrink:1 }}>
          {agents.slice(0, 2).map(agent => {
            ...
            return (
              <div key={agent.id} style={{ flex:1, minHeight:0, display:"flex", flexDirection:"column" }}>
                <div style={{ background:"#0d2030", border:`1px solid ${C.border}`, borderRadius:6, height:200, display:"flex", alignItems:"center", justifyContent:"center", color:C.dim, fontSize:10 }}>
